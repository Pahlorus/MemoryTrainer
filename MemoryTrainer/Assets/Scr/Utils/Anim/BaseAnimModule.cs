...
public class BaseAnimModule : MonoBehaviour
{
    ...
    /*
    public async UniTask Move(SMoveAnimData data, CancellationToken ct, bool isTimeScaleIgnore = false)
    {
        await Move(data.destPosition,  data.startPosition, data.durationTime, ct, isTimeScaleIgnore, data.ease);
    }
    */
    ...
    /*
    public async UniTask MoveLocale(SMoveAnimData data, CancellationToken ct, bool isTimeScaleIgnore = false)
    {
        await MoveLocale(data.destPosition, data.durationTime, data.startPosition, ct, isTimeScaleIgnore, data.ease);
    }
    */
